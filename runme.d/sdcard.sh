...
# Reserved partitions
start=4096 size=6MiB type=8DA63339-0007-60C0-C436-083AC8230908 name=Bootloader attrs=RequiredPartition
start=16384 size=1MiB type=8DA63339-0007-60C0-C436-083AC8230908 name=Environment attrs=RequiredPartition
# aarch64 root partition
start=64MiB name=Linux type=B921B045-1DF0-41C3-AF44-4C6F280D3FAE bootable
%PTBL%
